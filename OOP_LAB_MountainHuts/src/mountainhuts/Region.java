...
public class Region {
	...
	public void setAltitudeRanges(String... ranges) {
		for (String range : ranges) {
			AltitudeRange ar = new AltitudeRange(range);
	...
	private void readData(String file) {
		...
		//Rimuove la prima riga (intestazione)
		lines.remove(0);
		...
		lines.forEach((line) -> {
			...
			Municipality m = createOrGetMunicipality(municipalityName, province, municipalityAltitude);
			
			//Rifugio
			String name = fields[3];
			String altitude = fields[4];
			String category = fields[5];
			Integer bedsNumber = Integer.parseInt(fields[6]);
			
			if (altitude.equals("")) {
				createOrGetMountainHut(name, category, bedsNumber, m);
			} else createOrGetMountainHut(name, Integer.parseInt(altitude), category, bedsNumber, m);
